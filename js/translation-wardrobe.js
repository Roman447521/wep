...
const translations = {
    'ua': {
        ...
        'filter-title-kind': 'Вид шаф',

        // Сайдбар - Пункти (Типи)
        'type-office': 'Гостьові ',
        'type-computer': 'Комп\'ютерні ',
        'type-soft': 'Для вуличного використання ',
        'type-rocking': 'Шкіряні ',
        'type-kids': 'Дитячі ',
        'type-beanbag': 'Безкаркасні ',
        'type-massage': 'Вбудовані ',
        'type-bar': 'Барні ',
    ...
    'en': {
        ...
        'type-soft': 'Outdoor ',
        'type-rocking': 'Leather ',
        'type-kids': 'Kids ',
        'type-beanbag': 'Beanbag ',
        'type-massage': 'Closets ',
        'type-bar': 'Bar ',
