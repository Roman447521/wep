...
const translations = {
    'ua': {
        ...
        'filter-title-kind': 'Вид полиць',

        // Сайдбар - Пункти (Типи)
        'type-office': 'Дерев\'яні ',
        'type-computer': 'Комп\'ютерні ',
        'type-soft': 'Пластикові книжкові шафи',
        'type-rocking': 'Металеві ',
        'type-kids': 'Дитячі ',
        'type-beanbag': 'Безкаркасні ',
        'type-massage': 'Гранітні ',
        'type-bar': 'Барні ',
    ...
    'en': {
        ...
        'type-soft': 'Plastic Bookshelfs',
        'type-rocking': 'Metal ',
        'type-kids': 'Kids ',
        'type-beanbag': 'Beanbag ',
        'type-massage': 'Granite ',
        'type-bar': 'Bar ',
