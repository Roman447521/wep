...
const translations = {
    'ua': {
        ...
        'filter-title-kind': 'Вид ліжок',

        // Сайдбар - Пункти (Типи)
        'type-office': 'Дерев\'яні ліжка',
        'type-computer': 'Комп\'ютерні ліжка',
        'type-soft': 'М\'які ліжка',
        'type-rocking': 'Металеві ліжка',
        'type-kids': 'Дитячі ліжка',
        'type-beanbag': 'Безкаркасні ліжка ',
        'type-massage': 'Масажні ліжка ',
    ...
    'en': {
        ...
        // Sidebar - Items
        'type-office': 'Wooden beds',
        'type-computer': 'Computer beds',
        'type-soft': 'Soft beds',
        'type-rocking': 'Metal beds',
        'type-kids': 'Kids Chairs',
        'type-beanbag': 'Bean Bags',
        'type-massage': 'Massage beds',
